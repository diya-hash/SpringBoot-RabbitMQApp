...
import com.rabbitmq.example.RabbitMQApp.producer.RabbitMQTopicExchangeProducer;

@RestController
@RequestMapping("/TE")
public class TEMessageController {
	private final RabbitMQTopicExchangeProducer teProducer;
	
	
	public TEMessageController(RabbitMQTopicExchangeProducer teProducer) {
